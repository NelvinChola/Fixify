...
<div class="card p-4 mb-4 border-0 text-white position-relative overflow-hidden" 
    ...
    <div class="position-absolute top-0 end-0 w-50 h-100 opacity-10">
        <div class="w-100 h-100" style="background: radial-gradient(circle, rgba(255,255,255,0.3) 1px, transparent 1px);
                ...
                @if($request->device->image ?? false)
                    <div class="bg-white rounded-3 p-2 shadow-lg" 
                        ...
                        <img src="{{ asset('storage/' . $request->device->image) }}" 
                             alt="{{ $request->device->name ?? 'Device Image' }}"
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-light"><strong class="text-warning">Brand:</strong> {{ $request->device->brand ?? 'N/A' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-light"><strong class="text-warning">Model:</strong> {{ $request->device->model }}</span>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-light"><strong class="text-warning">Serial:</strong> {{ $request->device->serial_number }}</span>
                            </div>
                        </div>
                        @endif
                    </div>
            ...
            <div class="card border-0 bg-light h-100">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-control bg-white border-0 fw-bold fs-5 
                        ...
                        <div class="alert alert-success border-0 mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Full payment received. Customer can collect the device.</p>
                                    @if($request->paid_at)
                        ...
                        <div class="alert alert-warning border-0 mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Balance of K{{ number_format($request->final_cost - $request->amount_paid, 2) }} still due.</p>
                                </div>
                            </div>
                        </div>
                    @else
                        <div class="alert alert-danger border-0 mb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 small">Customer needs to pay K{{ number_format($request->final_cost, 2) }} to collect device.</p>
                                </div>
                            </div>
                        </div>
                    @endif
...
@endif
    ...
    <div class="card p-4 mb-4 shadow-sm border-0 bg-warning bg-opacity-10">
        ...
        <p class="text-muted mb-3">
            This job card was sent back by the technician. You can either assign it to another technician or archive it if no further action is needed.
        </p>
            ...
            <div class="col-md-6">
                <div class="card border-0 bg-light h-100">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#reassignTechnicianModal">
            ...
            <div class="col-md-6">
                <div class="card border-0 bg-light h-100">
                    <div class="card-body text-center">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#archiveJobCardModal">
    ...
    <div class="card p-4 mb-4 shadow-sm border-0">
        <h5 class="fw-semibold mb-3">
            Update Status
            @if($isHelpdesk && in_array($request->status, ['assigned', 'diagnosis', 'repairing', 'completed', 'unsuccessful', 'sent_back']))
        ...
        @php
            ...
            } elseif($isHelpdesk && in_array($request->status, ['assigned', 'diagnosis', 'repairing', 'completed', 'unsuccessful', 'sent_back'])) {
                $isDisabled = true;
        ...
        @elseif(!empty($nextStatuses))
            <div class="d-flex flex-wrap gap-2">
                @foreach($nextStatuses as $status)
                    @php
                        $requiresNotes = ($isHelpdesk && $status == 'assessed') || ($isTechnician && $status == 'unsuccessful');
                        $modalId = ($isHelpdesk && $status == 'assessed') ? 'assessmentModal' : (($isTechnician && $status == 'unsuccessful') ? 'unsuccessfulModal' : '');
                    ...
                    @else
                        <form action="{{ route('JobCard.update-status', $request->id) }}" method="POST" class="d-inline">
                            @csrf
            ...
            <div class="w-100">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <p class="mb-1"><strong>Additional Amount:</strong> K{{ number_format($request->additional_fees, 2) }}</p>
                        <p class="mb-1"><strong>Initial Cost:</strong> K{{ number_format($request->total_cost, 2) }}</p>
                        <p class="mb-0"><strong>Final Cost:</strong> K{{ number_format($request->final_cost ?? ($request->total_cost + $request->additional_fees), 2) }}</p>
                    </div>
                    <div class="text-end">
...
@endif 
    ...
    <div class="card p-4 mb-4 shadow-sm border-0 bg-warning bg-opacity-10">
        ...
        <p class="text-muted mb-3">
            If you cannot proceed with repairing this product, you can send it back to the helpdesk with additional notes.
        </p>
        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#sentBackModal">
            <i class="fas fa-undo me-2"></i>Send Back to Helpdesk
        </button>
    </div>
    @endif
    ...
    <div class="card p-4 shadow-sm border-0">
        ...
        <div class="status-progress">
            ...
            <div class="d-flex justify-content-between align-items-center position-relative mb-4">
                <!-- Progress Line -->
                <div class="position-absolute top-50 start-0 end-0" style="height: 3px; background: #e9ecef; z-index: 1;"></div>
                ...
                @foreach($statusFlow as $index => $status)
                    @php
                        ...
                        if ($isFinalized || $index <= array_search($currentStatus, $statusFlow) || ($isSentBack && $index <= 2)) {
                            if (($status == 'assessed' && $index == array_search($currentStatus, $statusFlow) && !$request->technician_id) || $isSentBack) {
                                $isBlockedStep = true;
                            } else {
                                $isCompleted = true;
                            }
                    ...
                    <div class="d-flex flex-column align-items-center position-relative" style="z-index: 3;">
                        <div class="status-circle 
                            ...
                            <i class="fas 
                                ...
                                @elseif($status == 'repairing') fa-tools
                                @endif">
                            </i>
                            @if($isBlockedStep)
                ...
                <div class="col-12">
                    <div class="text-center">
                        <div class="sent-back-indicator">
                            ...
                            <p class="text-muted">This job card requires additional assessment from the helpdesk team.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-4">
                <div class="final-outcome">
                    @if($isFinalized)
                        <div class="status-circle status-final 
                        ...
                        <p class="text-muted">
                            @if($currentStatus == 'completed')
                                The device has been successfully repaired and the customer can collect upon making a payment.
                            @else
                                The repair was unsuccessful, the device cannot be repaired by <span class="text-primary">{{ $request->technician->name }}</span>.
                            @endif
                        </p>
                    @else
                        <div class="status-circle status-final 
                        ...
                        <h5 class="mt-3 
                            ...
                            @else text-muted @endif">
                            @if($isSentBack) Sent Back to Helpdesk
                            @elseif($isBlocked) Awaiting Technician Assignment
                            @else Ready for Finalization @endif
                        </h5>
                        <p class="text-muted">
                            @if($isSentBack)
...
<div class="modal fade" id="assessmentModal" tabindex="-1" aria-labelledby="assessmentModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('JobCard.update-status', $request->id) }}" method="POST" id="assessmentForm">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="assessment_notes" name="assessment_notes" 
                                  rows="4" placeholder="Enter assessment details, findings, and initial recommendations..." 
                                  required>{{ old('assessment_notes') }}</textarea>
        ...
        <div class="modal-content">
            <div class="modal-header 
                ...
                <h5 class="modal-title" id="paymentManagementModalLabel">
                    ...
                    @if($request->payment_status === 'partial') Update Payment
                    @else Record Payment @endif
                </h5>
                <button type="button" class="btn-close 
                    @if($request->payment_status === 'partial') 
                    @else btn-close-white @endif" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('JobCard.update-payment', $request->id) }}" method="POST" id="paymentManagementForm">
                @csrf
                <div class="modal-body">
                    <div class="alert 
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="mb-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <strong class="text-dark">K{{ number_format($request->final_cost, 2) }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <strong class="text-success">K{{ number_format($request->amount_paid, 2) }}</strong>
                                </div>
                            </div>
                            ...
                            <div class="mb-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <strong class="text-danger">K{{ number_format($request->final_cost - $request->amount_paid, 2) }}</strong>
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="number" 
                                   ...
                                   name="amount_paid" 
                                   min="0" 
                                   max="{{ $request->final_cost + 1000 }}"
                                   step="0.01"
                                   value="{{ old('amount_paid', $request->amount_paid ?? 0) }}"
                                   placeholder="0.00"
                    ...
                    <div class="mb-4" id="paymentProgressContainer" style="display: none;">
                        ...
                        <small class="text-muted mt-1">
                            <span id="progressAmount">K0.00</span> of K{{ number_format($request->final_cost, 2) }}
                        </small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="paymentMethod" name="payment_method">
                            ...
                            <option value="cash" {{ old('payment_method', $request->payment_method ?? '') == 'cash' ? 'selected' : '' }}>Cash</option>
                            <option value="mobile_money" {{ old('payment_method', $request->payment_method ?? '') == 'mobile_money' ? 'selected' : '' }}>Mobile Money</option>
                            <option value="bank_transfer" {{ old('payment_method', $request->payment_method ?? '') == 'bank_transfer' ? 'selected' : '' }}>Bank Transfer</option>
                            <option value="card" {{ old('payment_method', $request->payment_method ?? '') == 'card' ? 'selected' : '' }}>Card Payment</option>
    ...
    if (paymentForm) {
        paymentForm.addEventListener('submit', function(e) {
            ...
            if (status === 'paid' && (currentPaid + amount) < finalCost) {
                e.preventDefault();
                alert('Amount must be equal to or greater than the remaining balance to mark as fully paid.');
                paymentAmount.focus();
                return false;
            }
            ...
            <form action="{{ route('JobCard.update-status', $request->id) }}" method="POST" id="diagnosisForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="diagnosis_notes" name="diagnosis_notes" 
                                  rows="4" placeholder="Enter detailed diagnosis findings, identified issues, and repair recommendations..." 
                                  required>{{ old('diagnosis_notes') }}</textarea>
...
@if($isTechnician)
<div class="modal fade" id="unsuccessfulModal" tabindex="-1" aria-labelledby="unsuccessfulModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('JobCard.update-status', $request->id) }}" method="POST" id="unsuccessfulForm">
                @csrf
                ...
                <div class="modal-body">
                    <div class="alert alert-danger">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>Important:</strong> Please provide detailed explanation why the repair was unsuccessful.
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="unsuccessful_notes" name="unsuccessful_notes" 
                                  rows="4" placeholder="Explain why the repair could not be completed successfully. Include technical challenges, part availability issues, or other factors..." 
            ...
            <form action="{{ route('JobCard.update-status', $request->id) }}" method="POST" id="completedForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="repair_summary" name="repair_summary" 
                                  rows="4" placeholder="Describe the repair work completed, parts replaced, and final testing results..." 
                                  required>{{ old('repair_summary') }}</textarea>
                        <small class="text-muted">This summary will help the customer understand what was done.</small>
                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="total_cost" 
                                       name="total_cost" step="0.01" min="0" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="parts_used" name="parts_used" 
                                  rows="2" placeholder="List any parts that were replaced during the repair...">{{ old('parts_used') }}</textarea>
                    </div>

                    <div class="form-check mb-3">
                        <input class="form-check-input" type="checkbox" id="quality_check" name="quality_check" value="1" required>
...
@if($isTechnician)
<div class="modal fade" id="sentBackModal" tabindex="-1" aria-labelledby="sentBackModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('JobCard.sent-back', $request->id) }}" method="POST" id="sentBackForm">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>Note:</strong> This will send the job card back to the helpdesk for further assessment.
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="sent_back_notes" name="sent_back_notes" 
                                  rows="4" placeholder="Explain why you need to send this job card back to helpdesk. Include any issues, clarifications needed, or additional information required..." 
...
@if(!$isTechnician && $request->status == 'sent_back')
<div class="modal fade" id="reassignTechnicianModal" tabindex="-1" aria-labelledby="reassignTechnicianModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
            ...
            <form action="{{ route('JobCard.reassign-technician', $request->id) }}" method="POST" id="reassignTechnicianForm">
                @csrf
                @method('POST')
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0">This job card was sent back by <strong>{{ $request->technician->name ?? 'Previous Technician' }}</strong>. 
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select" id="new_technician_id" name="technician_id" required>
                            ...
                            @foreach($technicians as $tech)
                                @if($tech->id != $request->technician_id) {{-- Exclude current technician --}}
                                    <option value="{{ $tech->id }}" 
                                        ...
                                        @if($tech->active_jobs_count ?? false)
                                            <small class="text-muted">({{ $tech->active_jobs_count }} active jobs)</small>
                                        @endif
                                    </option>
                                @endif
                            @endforeach
                        </select>
                        <small class="text-muted">Choose a technician with appropriate skills for this repair.</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="reassignment_notes" name="reassignment_notes" 
                                  rows="3" placeholder="Add any specific instructions or context for the new technician...">{{ old('reassignment_notes') }}</textarea>
                        <small class="text-muted">These notes will help the new technician understand the situation.</small>
                    </div>
...
@if(!$isTechnician && $request->status == 'sent_back')
<div class="modal fade" id="archiveJobCardModal" tabindex="-1" aria-labelledby="archiveJobCardModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('JobCard.archive', $request->id) }}" method="POST" id="archiveJobCardForm">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="mb-0">Archiving will move this job card to archived records. This action should only be taken if no further repair attempts are needed or possible.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="archive_notes" name="archive_notes" 
                                  rows="4" placeholder="Provide detailed explanation for archiving this job card..." 
                                  required>{{ old('archive_notes') }}</textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row small">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <strong>Technician:</strong> {{ $request->technician->name ?? 'Not Assigned' }}<br>
                    ...
                    <div class="alert alert-danger mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="archive_confirmation" name="archive_confirmation" value="1" required>
                            <label class="form-check-label fw-bold" for="archive_confirmation">
                                <i class="fas fa-exclamation-circle me-1"></i>
                                I understand that archiving this job card will move it to permanent records and no further repairs will be attempted.
                            </label>
                        </div>
                    </div>
...
<div class="modal fade" id="partsUsedModal" tabindex="-1" aria-labelledby="partsUsedModalLabel" aria-hidden="true">
