                ...
                <div class="card shadow-lg w-100" style="max-width: 1200px;">
                    ...
                    <div class="card-body px-5">
                        <form method="POST" action="{{ route('users.update', $user->id) }}">
                            ...
                            <!-- Contact -->
                            <div class="row mb-4 align-items-start">
                                <label for="contact" class="col-md-3 col-form-label fw-semibold">Contact*</label>
                                <div class="col-md-9">
                                    <input type="text" id="contact" class="form-control @error('contact') is-invalid @enderror" name="contact" value="{{ old('contact', $user->contact) }}" required>
                                    @error('contact')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <!-- NRC -->
                            <div class="row mb-4 align-items-start">
                                <label for="nrc" class="col-md-3 col-form-label fw-semibold">NRC</label>
                                <div class="col-md-9">
                                    <input type="text" id="nrc" class="form-control @error('nrc') is-invalid @enderror" name="nrc" value="{{ old('nrc', $user->nrc) }}">
                                    @error('nrc')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-4 align-items-start">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address', $user->address) }}">
                                    @error('address')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                ...
                                <button type="submit" class="btn text-white" style="background:#1e1e2d;"><i class="fas fa-save me-2"></i>Update User</button>
                            </div>
                        </form>
                    </div>
                </div>
