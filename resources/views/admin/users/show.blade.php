                    ...
                    <div class="card-body px-5">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3 fw-semibold">Contact</div>
                                    <div class="col-md-9">{{ $user->contact ?? '-' }}</div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-3 fw-semibold">NRC</div>
                                    <div class="col-md-9">{{ $user->nrc ?? '-' }}</div>
                                </div>
                                <div class="row mb-3">
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-4">
                            ...
                            <a href="{{ route('users.edit', $user->id) }}" class="btn text-white" style="background:#1e1e2d;">
