            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <h4 class="mb-0">{{ $issueCategory->name }}</h4>
                    </div>
                    ...
                    <ul class="list-group list-group-flush mb-4">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            ...
                            <span>{{ $issueCategory->description ?? 'No description provided' }}</span>
                        </li>
                    </ul>

                    <!-- Buttons -->
                    <div class="text-end">
                        <a href="{{ route('issueCategories.edit', $issueCategory->id) }}" class="btn btn-sm btn-primary me-2">
                            <i class="bi bi-pencil-square me-1"></i> Edit
                        </a>
                        <a href="{{ route('issueCategories.index') }}" class="btn btn-sm btn-secondary">
